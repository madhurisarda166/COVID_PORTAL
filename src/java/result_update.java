 ...
 * @author hp
 */
public class result_update extends HttpServlet {
...
"    </div>");
     ...
     //}
       // out.println(c);
        ...
        out.println("<h1 align='center'>Patients Sample List</h1>");
        out.println("<hr>");
        ...
        out.println("<td><b>Positive</td>");
        out.println("<td><b>Negative</td>");
        out.println("</tr>");
        ...
        out.println("<td><a href=Last_page?rid="+s1+"&res=Positive>+</a></td>");
        out.println("<td><a href=Last_page?rid="+s1+"&res=Negative>-</a></td>");
        out.println("</tr>");
